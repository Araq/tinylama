...
proc cufftCreate*(handle: ptr cufftHandle): cufftResult {.discardable, cdecl,
...
proc cufftGetSize*(handle: cufftHandle; workSize: ptr csize_t): cufftResult {.discardable, cdecl,
    importc: "cufftGetSize", dynlib: libName.}
proc cufftSetWorkArea*(plan: cufftHandle; workArea: pointer): cufftResult {.discardable, cdecl,
    importc: "cufftSetWorkArea", dynlib: libName.}
proc cufftSetAutoAllocation*(plan: cufftHandle; autoAllocate: cint): cufftResult {.discardable,
...
proc cufftExecR2C*(plan: cufftHandle; idata: ptr cufftReal; odata: ptr cufftComplex): cufftResult {.discardable,
    cdecl, importc: "cufftExecR2C", dynlib: libName.}
proc cufftExecC2R*(plan: cufftHandle; idata: ptr cufftComplex; odata: ptr cufftReal): cufftResult {.discardable,
...
proc cufftSetStream*(plan: cufftHandle; stream: cudaStream_t): cufftResult {.discardable, cdecl,
    importc: "cufftSetStream", dynlib: libName.}
proc cufftDestroy*(plan: cufftHandle): cufftResult {.discardable, cdecl, importc: "cufftDestroy",
    dynlib: libName.}
proc cufftGetVersion*(version: ptr cint): cufftResult {.discardable, cdecl,

...
proc cublasCreate_v2*(handle: ptr cublasHandle_t): cublasStatus_t {.discardable, cdecl,
    importc: "cublasCreate_v2", dynlib: libName.}
proc cublasDestroy_v2*(handle: cublasHandle_t): cublasStatus_t {.discardable, cdecl,
    importc: "cublasDestroy_v2", dynlib: libName.}
proc cublasGetVersion_v2*(handle: cublasHandle_t; version: ptr cint): cublasStatus_t {.discardable,
...
proc cublasSetStream_v2*(handle: cublasHandle_t; streamId: cudaStream_t): cublasStatus_t {.discardable,
    cdecl, importc: "cublasSetStream_v2", dynlib: libName.}
proc cublasGetStream_v2*(handle: cublasHandle_t; streamId: ptr cudaStream_t): cublasStatus_t {.discardable,
    cdecl, importc: "cublasGetStream_v2", dynlib: libName.}
proc cublasGetPointerMode_v2*(handle: cublasHandle_t; mode: ptr cublasPointerMode_t): cublasStatus_t {.discardable,
    cdecl, importc: "cublasGetPointerMode_v2", dynlib: libName.}
proc cublasSetPointerMode_v2*(handle: cublasHandle_t; mode: cublasPointerMode_t): cublasStatus_t {.discardable,
    cdecl, importc: "cublasSetPointerMode_v2", dynlib: libName.}
proc cublasGetAtomicsMode*(handle: cublasHandle_t; mode: ptr cublasAtomicsMode_t): cublasStatus_t {.discardable,
    cdecl, importc: "cublasGetAtomicsMode", dynlib: libName.}
proc cublasSetAtomicsMode*(handle: cublasHandle_t; mode: cublasAtomicsMode_t): cublasStatus_t {.discardable,
    cdecl, importc: "cublasSetAtomicsMode", dynlib: libName.}
proc cublasGetMathMode*(handle: cublasHandle_t; mode: ptr cublasMath_t): cublasStatus_t {.discardable,
    cdecl, importc: "cublasGetMathMode", dynlib: libName.}
proc cublasSetMathMode*(handle: cublasHandle_t; mode: cublasMath_t): cublasStatus_t {.discardable,
    cdecl, importc: "cublasSetMathMode", dynlib: libName.}
proc cublasGetSmCountTarget*(handle: cublasHandle_t; smCountTarget: ptr cint): cublasStatus_t {.discardable,
    cdecl, importc: "cublasGetSmCountTarget", dynlib: libName.}
proc cublasSetSmCountTarget*(handle: cublasHandle_t; smCountTarget: cint): cublasStatus_t {.discardable,
...
proc cublasSetLoggerCallback*(userCallback: cublasLogCallback): cublasStatus_t {.discardable,
    cdecl, importc: "cublasSetLoggerCallback", dynlib: libName.}
proc cublasGetLoggerCallback*(userCallback: ptr cublasLogCallback): cublasStatus_t {.discardable,

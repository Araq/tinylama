...
type
  cusolverRfUnitDiagonal_t* {.size: sizeof(cint).} = enum
    ...
    CUSOLVERRF_UNIT_DIAGONAL_STORED_U = 1, CUSOLVERRF_UNIT_DIAGONAL_ASSUMED_L = 2,
...
type cusolverRfCommon {.nodecl.} = object
type
...
proc cusolverRfCreate*(handle: ptr cusolverRfHandle_t): cusolverStatus_t {.discardable, cdecl,
    importc: "cusolverRfCreate", dynlib: libName.}
proc cusolverRfDestroy*(handle: cusolverRfHandle_t): cusolverStatus_t {.discardable, cdecl,
...
proc cusolverRfGetResetValuesFastMode*(handle: cusolverRfHandle_t; fastMode: ptr cusolverRfResetValuesFastMode_t): cusolverStatus_t {.discardable,
...
proc cusolverRfAnalyze*(handle: cusolverRfHandle_t): cusolverStatus_t {.discardable, cdecl,
    importc: "cusolverRfAnalyze", dynlib: libName.}
##  CUSOLVERRF re-factorization (for parallelism)

proc cusolverRfRefactor*(handle: cusolverRfHandle_t): cusolverStatus_t {.discardable, cdecl,
...
proc cusolverRfExtractSplitFactorsHost*(handle: cusolverRfHandle_t;
                                       ...
                                       h_csrValL: ptr ptr cdouble; h_nnzU: ptr cint;
                                       h_csrRowPtrU: ptr ptr cint;
                                       h_csrColIndU: ptr ptr cint;
                                       h_csrValU: ptr ptr cdouble): cusolverStatus_t {.
    cdecl, importc: "cusolverRfExtractSplitFactorsHost", dynlib: libName.}
  ##  Input
  ##  Output (in the host memory)
...
proc cusolverRfBatchAnalyze*(handle: cusolverRfHandle_t): cusolverStatus_t {.discardable, cdecl,
    importc: "cusolverRfBatchAnalyze", dynlib: libName.}
##  CUSOLVERRF-batch re-factorization (for parallelism)

proc cusolverRfBatchRefactor*(handle: cusolverRfHandle_t): cusolverStatus_t {.discardable, cdecl,
...
proc cusolverRfBatchZeroPivot*(handle: cusolverRfHandle_t; position: ptr cint): cusolverStatus_t {.discardable,

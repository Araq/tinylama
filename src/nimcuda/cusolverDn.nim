...
when not defined(CUSOLVERDN_H):
  ...
  ## ****************************************************************************
  proc cusolverDnCreate*(handle: ptr cusolverDnHandle_t): cusolverStatus_t {.discardable, cdecl,
      importc: "cusolverDnCreate", dynlib: libName.}
  proc cusolverDnDestroy*(handle: cusolverDnHandle_t): cusolverStatus_t {.discardable, cdecl,
      importc: "cusolverDnDestroy", dynlib: libName.}
  proc cusolverDnSetStream*(handle: cusolverDnHandle_t; streamId: cudaStream_t): cusolverStatus_t {.discardable,
      cdecl, importc: "cusolverDnSetStream", dynlib: libName.}
  proc cusolverDnGetStream*(handle: cusolverDnHandle_t; streamId: ptr cudaStream_t): cusolverStatus_t {.discardable,
  ...
  ##  =============================================================================
  proc cusolverDnIRSParamsCreate*(params_ptr: ptr cusolverDnIRSParams_t): cusolverStatus_t {.discardable,
      cdecl, importc: "cusolverDnIRSParamsCreate", dynlib: libName.}
  proc cusolverDnIRSParamsDestroy*(params: cusolverDnIRSParams_t): cusolverStatus_t {.discardable,
  ...
  proc cusolverDnIRSParamsSetTol*(params: cusolverDnIRSParams_t; val: cdouble): cusolverStatus_t {.discardable,
      cdecl, importc: "cusolverDnIRSParamsSetTol", dynlib: libName.}
  proc cusolverDnIRSParamsSetTolInner*(params: cusolverDnIRSParams_t; val: cdouble): cusolverStatus_t {.discardable,
  ...
  proc cusolverDnIRSParamsEnableFallback*(params: cusolverDnIRSParams_t): cusolverStatus_t {.discardable,
      cdecl, importc: "cusolverDnIRSParamsEnableFallback", dynlib: libName.}
  proc cusolverDnIRSParamsDisableFallback*(params: cusolverDnIRSParams_t): cusolverStatus_t {.discardable,
      cdecl, importc: "cusolverDnIRSParamsDisableFallback", dynlib: libName.}
  ##  =============================================================================
  ##  cusolverDnIRSInfos prototypes
  ##  =============================================================================
  proc cusolverDnIRSInfosDestroy*(infos: cusolverDnIRSInfos_t): cusolverStatus_t {.discardable,
      cdecl, importc: "cusolverDnIRSInfosDestroy", dynlib: libName.}
  proc cusolverDnIRSInfosCreate*(infos_ptr: ptr cusolverDnIRSInfos_t): cusolverStatus_t {.discardable,
  ...
  proc cusolverDnIRSInfosRequestResidual*(infos: cusolverDnIRSInfos_t): cusolverStatus_t {.discardable,
  ...
  proc cusolverDnCreateSyevjInfo*(info: ptr syevjInfo_t): cusolverStatus_t {.discardable, cdecl,
      importc: "cusolverDnCreateSyevjInfo", dynlib: libName.}
  proc cusolverDnDestroySyevjInfo*(info: syevjInfo_t): cusolverStatus_t {.discardable, cdecl,
      importc: "cusolverDnDestroySyevjInfo", dynlib: libName.}
  proc cusolverDnXsyevjSetTolerance*(info: syevjInfo_t; tolerance: cdouble): cusolverStatus_t {.discardable,
      cdecl, importc: "cusolverDnXsyevjSetTolerance", dynlib: libName.}
  proc cusolverDnXsyevjSetMaxSweeps*(info: syevjInfo_t; max_sweeps: cint): cusolverStatus_t {.discardable,
      cdecl, importc: "cusolverDnXsyevjSetMaxSweeps", dynlib: libName.}
  proc cusolverDnXsyevjSetSortEig*(info: syevjInfo_t; sort_eig: cint): cusolverStatus_t {.discardable,
  ...
  proc cusolverDnCreateGesvdjInfo*(info: ptr gesvdjInfo_t): cusolverStatus_t {.discardable, cdecl,
      importc: "cusolverDnCreateGesvdjInfo", dynlib: libName.}
  proc cusolverDnDestroyGesvdjInfo*(info: gesvdjInfo_t): cusolverStatus_t {.discardable, cdecl,
      importc: "cusolverDnDestroyGesvdjInfo", dynlib: libName.}
  proc cusolverDnXgesvdjSetTolerance*(info: gesvdjInfo_t; tolerance: cdouble): cusolverStatus_t {.discardable,
      cdecl, importc: "cusolverDnXgesvdjSetTolerance", dynlib: libName.}
  proc cusolverDnXgesvdjSetMaxSweeps*(info: gesvdjInfo_t; max_sweeps: cint): cusolverStatus_t {.discardable,
      cdecl, importc: "cusolverDnXgesvdjSetMaxSweeps", dynlib: libName.}
  proc cusolverDnXgesvdjSetSortEig*(info: gesvdjInfo_t; sort_svd: cint): cusolverStatus_t {.discardable,
  ...
  proc cusolverDnCreateParams*(params: ptr cusolverDnParams_t): cusolverStatus_t {.discardable,
      cdecl, importc: "cusolverDnCreateParams", dynlib: libName.}
  proc cusolverDnDestroyParams*(params: cusolverDnParams_t): cusolverStatus_t {.discardable,
  ...
  proc cusolverDnLoggerSetCallback*(callback: cusolverDnLoggerCallback_t): cusolverStatus_t {.discardable,
      cdecl, importc: "cusolverDnLoggerSetCallback", dynlib: libName.}
  proc cusolverDnLoggerSetFile*(file: ptr FILE): cusolverStatus_t {.discardable, cdecl,
      importc: "cusolverDnLoggerSetFile", dynlib: libName.}
  proc cusolverDnLoggerOpenFile*(logFile: cstring): cusolverStatus_t {.discardable, cdecl,
      importc: "cusolverDnLoggerOpenFile", dynlib: libName.}
  proc cusolverDnLoggerSetLevel*(level: cint): cusolverStatus_t {.discardable, cdecl,
      importc: "cusolverDnLoggerSetLevel", dynlib: libName.}
  proc cusolverDnLoggerSetMask*(mask: cint): cusolverStatus_t {.discardable, cdecl,
